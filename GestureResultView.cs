...
namespace Kinect.BodyStream
{
    ...
    public sealed class GestureResultView : INotifyPropertyChanged
    {
        ...
        public GestureResultView(int bodyIndex, string Name, bool isTracked, bool detected, float confidence)
        {
        ...
        public void UpdateGestureResult(bool isBodyTrackingIdValid, string Name,bool isGestureDetected, float detectionConfidence)
        {
